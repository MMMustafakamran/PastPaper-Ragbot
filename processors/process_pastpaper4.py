...
OUTPUT_ROOT = Path("processed_data/NET/NUST-Engineering-Pastpaper-4(educatedzone.com)")
...
MATH_KEYWORDS = {
    ...
    "Differentiation": ["derivative", "differentiation", "tangent", "normal", "maxima", "minima",
                        ...
                        "rolle's theorem", "rolle theorem", "stationary point", "twice differentiable",
                        "f(x)f'(x)", "max value", "maximum value", "min value", "minimum value"],
    ...
    "Trigonometry": ["sin", "cos", "tan", "cot", "sec", "cosec", "trigonometric", "radian", "degree",
                    "triangle", "angle", "sine", "cosine", "trigonometric ratio", "trigonometric function"],
    ...
    "Matrices and Determinants": ["matrix", "determinant", "singular", "non-singular", "transpose",
                                  "determinant with", "triangle angles"],
    ...
    "Sequences and Series": ["sequence", "series", "arithmetic", "geometric", "progression", "fibonacci", "harmonic",
                            "AP", "GP", "sum"],
    "Probability and Statistics": ["probability", "permutation", "permutations", "combination", "mean", "median", "mode",
    ...
    "Analytical Geometry": ["coordinate", "distance", "slope", "equation of line", "circle", "centroid", "locus",
                           "point", "line", "intersection", "intersecting orthogonally", "orthogonal",
                           "parametric equations", "parametric equation", "circles and triangles", "lines and locus"],
    "Conic Sections": ["parabola", "ellipse", "hyperbola", "conic", "focus", "directrix", "eccentricity",
                       "latus rectum", "transverse axis", "eccentric angle", "foci", "ellipse and circle"],
...
PHYSICS_KEYWORDS = {
    "Mechanics": ["force", "acceleration", "velocity", "momentum", "work", "energy", "power", "gravity",
                  ...
                  "projectile", "friction", "terminal velocity", "escape velocity",
    ...
    "Waves and Oscillations": ["wave motion", "wave", "frequency", "wavelength", "amplitude", "sound", "doppler", "resonance",
                               ...
                               "ultrasonic", "echo", "stationary wave", "progressive wave", "oscillation", "pendulum"],
    ...
    "Modern Physics": ["photon", "electron", "atom", "transistor", "laser", "photoelectric", "atomic structure",
                      "nuclear", "radioactive", "half-life", "isotope", "relativity", "lyman", "balmer",
                      "electromagnetic radiation", "radiation series", "spectral series"],
}
...
ENGLISH_KEYWORDS = {
    ...
    "Reading Comprehension": ["passage", "comprehension", "paragraph", "main idea", "context", "era",
                              "government", "economic", "freedom", "according to", "based on", "the text",
                              "the passage", "author", "implies", "suggests", "states"],
...
def parse_file() -> List[Dict]:
    ...
    for block in blocks:
        ...
        for line in block[1:]:
            # Check for option - handle both (a) and (a) formats
...
def classify_topic(question: Dict) -> Tuple[str, str]:
    ...
    if subject == "Mathematics":
        ...
        topic_map = {
            ...
            "Trigonometry": MATH_KEYWORDS["Trigonometry"],  # After geometry topics
