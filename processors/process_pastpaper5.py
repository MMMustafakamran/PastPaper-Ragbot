"""
Process NUST-Engineering-Pastpaper-5(educatedzone.com)_solved.txt
Subject divisions:
...
SOURCE_FILE = Path("data/Standard_text/NET/NUST-Engineering-Pastpaper-5(educatedzone.com)_solved.txt")
OUTPUT_ROOT = Path("processed_data/NET/NUST-Engineering-Pastpaper-5(educatedzone.com)")

# Topic keywords from Topics_net
MATH_KEYWORDS = {
    "Functions and Limits": ["function", "limit", "domain", "range", "continuous", "discontinuous", 
                             "identity", "explicit", "implicit", "inverse function",
    ...
    "Differentiation": ["derivative", "differentiation", "tangent", "normal", "maxima", "minima",
                        ...
                        "dy/dx at", "differential equation", "rolle's theorem", "stationary point",
                        "max value", "maximum value", "min value", "minimum value"],
    ...
    "Trigonometry": ["sin", "cos", "tan", "cot", "sec", "cosec", "trigonometric", "radian", "degree",
                    ...
                    "cosec⁻¹", "sec⁻¹", "angle of elevation", "trigonometric ratio", "trigonometric function"],
    ...
    "Vectors": ["vector", "dot product", "cross product", "magnitude", "direction", "i·", "k×", "j×",
               "collinear", "coplanar", "projection", "|u|", "|v|", "|w|", "unit vector",
               "work done by forces", "work done", "forces", "resultant", "force moments", "moment",
               "velocity and displacement", "displacement vector", "times of flight", "projectile motion",
               "initial velocity", "range R", "range"],
    "Sequences and Series": ["sequence", "series", "arithmetic", "geometric", "progression", "fibonacci", "harmonic",
                            "AP", "GP", "sum", "expansion", "binomial", "term independent"],
    "Probability and Statistics": ["probability", "permutation", "permutations", "combination", "combinations",
                                 "mean", "median", "mode", "standard deviation", "variance", "histogram",
                                 "words from", "arrangements", "number of words", "can be written", "letters of",
                                 "number of parallelograms", "parallelograms formed", "C₂", "C_2"],
    "Analytical Geometry": ["coordinate", "distance", "slope", "equation of line", "circle", "centroid", "locus",
                           "point", "line", "intersection", "plane", "sphere", "x²+y²",
                           "parametric equations", "parametric equation", "intersecting orthogonally", "orthogonal"],
...
PHYSICS_KEYWORDS = {
    "Mechanics": ["force", "acceleration", "velocity", "momentum", "work", "energy", "power", "gravity",
                  ...
                  "projectile", "projectile motion", "times of flight", "friction", "terminal velocity", "escape velocity",
    ...
    "Waves and Oscillations": ["wave motion", "wave", "frequency", "wavelength", "amplitude", "sound", "doppler", "resonance",
                               "oscillator", "simple harmonic", "simple harmonic motion", "simple harmonic oscillator",
                               "diffraction", "interference", "polarization", "oscillating disturbance",
    ...
    "Optics": ["lens", "refraction", "reflection", "optical", "light", "ray", "image", "phase change",
               ...
               "objective", "eye piece", "focal length", "distinct vision"],
    "Thermodynamics": ["temperature", "heat", "thermodynamics", "pressure", "kelvin", "gas", "expansion",
                      ...
                      "volume expansion", "mercury", "glass flask"],
...
ENGLISH_KEYWORDS = {
    "Grammar and Syntax": ["grammar", "syntax", "sentence", "tense", "clause", "structure", "suggested",
                          ...
                          "new", "equal", "honesty", "virtue"],
    "Vocabulary": ["synonym", "antonym", "meaning", "definition", "word", "idiom", "phrase",
                  "fragile", "esoteric", "synchronized", "chaotic", "bombastic", "strong", "weak",
                  "private", "arrhythmic", "orderly", "polite"],
    ...
    "Intelligence": ["analogy", "Iron", "blacksmith", "Fish", "scales", "Nose", "smell", "Collage",
                    "images", "Sketch", "artist", "Cotton", "cloth", "Food", "gourmet", "Clay",
                    "potter", "Silver", "miner", "Snakes", "fangs", "Birds", "feathers", "Car",
                    "wheels", "Tongue", "speak", "Foot", "hit", "Hand", "finger", "Teeth", "chew",
                    "Cement", "building", "Medley", "songs", "Furniture", "sofa", "Grains", "tree",
                    "Secret", "confident", "Cell", "prisoner", "Palette", "painter", "Draft", "writer"],
    "General Knowledge": ["president", "European union", "Greece", "Austria", "Germany", "Latvia",
                         "Chief Minister", "Punjab", "Javed mehmood", "Shahbaz sharif", "Captain arif Nadeem",
                         "Saudi foreign minister", "American foreign minister", "German foreign minister",
                         "French foreign minister", "international day", "peace", "world peace day",
                         "21st September", "elimination of violence", "racial discrimination", "23rd may",
                         "21st march", "KASHAF-UL-MAHJUB", "HAZRAT DATA GUNJ", "Maulana Altaf Hussain Hali",
                         "Maulana Shibli Nomani", "Maulana Zakaullah", "classical languages", "Chinese",
                         "Sanskrit", "Arabic", "Greek", "Latin", "nuclear plant", "Japan", "radioactive",
                         "water leak", "Ikata", "Kashiwazaki", "Kariwa", "Fukushima", "Hamaoka",
                         "Oxford university", "London school of economics", "Cambridge university",
                         "Harvard university", "FIA", "Federal investigation agency"],
}
...
def parse_file() -> List[Dict]:
    ...
    for block in blocks:
        ...
        for line in block[1:]:
            # Check for option - handle a. format (no parentheses)
        ...
        if not options or not answer_key:
            # Handle special cases where answer might be incomplete
            if "(incomplete" in str(block).lower() or "(missing" in str(block).lower():
                continue
...
def classify_topic(question: Dict) -> Tuple[str, str]:
    ...
    if subject == "Mathematics":
        # Priority order: check specific topics before general ones
        topic_map = {
            ...
            "Groups": MATH_KEYWORDS["Groups"],
            "Trigonometry": MATH_KEYWORDS["Trigonometry"],  # After vectors and geometry
            "Functions and Limits": MATH_KEYWORDS["Functions and Limits"],  # Last as default
        ...
        topic_map = {
            ...
            "General Knowledge": ENGLISH_KEYWORDS["General Knowledge"],
