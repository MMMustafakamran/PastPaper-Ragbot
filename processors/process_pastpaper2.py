...
OUTPUT_ROOT = Path("processed_data/NET/NUST-Engineering-Pastpaper-2(educatedzone.com)")
...
MATH_KEYWORDS = {
    ...
    "Differentiation": ["derivative", "differentiation", "tangent", "normal", "maxima", "minima",
                        ...
                        "stationary point", "stationary points", "f''(x)=0", "f''(x) = 0"],
    "Integration": ["integral", "integration", "definite", "indefinite", "area under curve",
                   "substitution", "by parts", "partial fractions", "∫"],
    "Trigonometry": ["sin", "cos", "tan", "cot", "sec", "cosec", "trigonometric", "radian", "radians", "degree",
                    "triangle", "angle", "sine", "cosine", "sin^{-1}", "cos^{-1}", "sec^2", "cos^2", "45°", "degrees"],
    "Complex Numbers": ["complex", "imaginary", "iota", "real component", "imaginary component", "|z|", "arg",
                       "conjugate", "modulus", "i^{", "i^", "a+bi", "(a,b)", "a+ib", "real part", "imaginary part"],
    ...
    "Sets and Logic": ["set", "subset", "element", "union", "intersection", "proposition", "conjunction",
                      "disjunction", "deduction", "induction", "truth", "logical", "p∧q", "p and q",
                      "aristotelian", "identity relation", "relation", "enrolled", "percentage", "houses",
                      "venn diagram", "set theory"],
    "Number Systems": ["rational", "irrational", "integer", "natural", "whole", "real number",
                      "additive", "multiplicative", "identity element", "inverse element"],
...
PHYSICS_KEYWORDS = {
    ...
    "Electricity and Magnetism": ["electric", "charge", "field", "current", "voltage", "resistance", "capacitor",
                                  ...
                                  "coulomb", "coulomb's law", "coulomb's force", "potential gradient", 
                                  "electric intensity", "electric potential", "resistivity", "weber",
                                  "solenoid", "henry", "reactance", "RLC", "resonant", "back motor torque",
    ...
    "Thermodynamics": ["temperature", "heat", "thermodynamics", "pressure", "kelvin", "gas", "expansion",
                      ...
                      "density", "volume", "perpetual motion", "second law", "thermodynamic"],
...
CHEM_KEYWORDS = {
    ...
    "Acids and Bases": ["ph", "acid", "base", "neutralization", "ammonium", "litmus", "poh", "buffer",
                        "pure water", "poor conductor", "conductor", "conductivity"],
    "Chemical Reactions": ["equilibrium", "reaction", "mass action", "law of mass action", "rate", "ksp", 
                           "spontaneous", "reversible", "irreversible", "forward reaction", "reverse reaction",
                           "Le Chatelier", "equilibrium constant", "haber's process", "haber process"],
    ...
    "Stoichiometry": ["mole", "molar", "Avogadro", "N_{A}", "g-atom", "STP", "calcium carbonate",
                     "CaCO_{3}", "limestone", "CO_{2}", "O_{2}", "H_{2}", "percentage composition",
                     "empirical formula", "molecular formula", "vapors density", "molar mass",
                     "concentration", "M", "stoichiometric"],
    "States of Matter": ["ideal gas", "kinetic", "critical temperature", "critical pressure", "liquefied",
                        "kinetic energy of ideal gas", "kinetic energy", "gas kinetic"],
}
