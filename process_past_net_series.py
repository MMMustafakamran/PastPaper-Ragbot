...
OUTPUT_ROOT = Path("processed_data/NET/past_net_series")
...
MATH_KEYWORDS = {
    ...
    "Complex Numbers": ["complex", "imaginary", "iota", "real component", "imaginary component", "|z|", "arg",
                       ...
                       "real part", "z = z̅", "cube root of unity", "w²³", "w²⁸"],
    ...
    "Probability and Statistics": ["probability", "permutation", "combination", "mean", "median", "mode",
                                 "standard deviation", "variance", "histogram", "dice", "rolled", "dice is rolled",
                                 "diamond card", "deck cards", "nP4", "nC3", "nP3"],
    ...
    "Conic Sections": ["parabola", "ellipse", "hyperbola", "conic", "focus", "directrix", "eccentricity",
                     ...
                     "e>1", "cut is parallel", "latus rectum"],
    ...
    "Number Systems": ["rational", "irrational", "integer", "natural", "whole", "real", "complex",
                     ...
                     "additive inverse", "repeating decimal", "0.4545"],
}
...
CHEM_KEYWORDS = {
    ...
    "Physical Chemistry": ["colloid", "As₂S₃", "coagulating", "Al³⁺", "ice", "water", "density",
                           ...
                           "least no.of carbon atoms", "amino acid"],
}
